 ...
 *
 * `lastMorningDay` — местная дата последнего поставленного утреннего
 * (отправленного или ждущего отправки), в днях от эпохи. Пусто — не
 * ставили ни разу, значит пора. Именно поставленного: см. `lastMorningDay`
 * в `reminders.repo.ts`, находка с боя 13.09.2026.
 *
