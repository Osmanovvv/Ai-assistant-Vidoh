 ...
 *
 * **Пометки в базе у этого пропуска нет и не нужно:** напоминание в
 * тишине не создаётся вовсе — отсев идёт при планировании (`plan.ts`).
 * Константа `QUIET_SKIP_REASON = 'quiet'` жила здесь без единого вызова
 * и обещала в базе значение, которого там никогда не было (3.82).
 */
