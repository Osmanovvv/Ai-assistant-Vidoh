 ...
 * слов, есть хотя бы одна буква, нет цифр и нет ссылок. Ограничения не
 * ради красоты: чем строже, тем меньше шанс, что коротко сказанная мысль
 * («купить хлеб») будет принята за имя. Совсем этот шанс не убрать —
 * поэтому бот сразу показывает, как теперь зовёт, и человек видит промах
 * в ту же секунду.
 */
