...
describe('время из слов человека', () => {
  ...
  it('«вечера», «дня», «ночи» — это половина суток, а не мусор (ревизия этапа 3, D14)', () => {
    /**
     * «7 вечера» вырезалось до «7» и становилось семью утра: человек
     * просил вечернее в 19:00, а получал в 07:00. Слово «утра» не
     * меняло числа и потому дефекта не показывало.
     */
    const cases: readonly [string, string][] = [
      ['7 вечера', '19:00'],
      ['в 7 вечера', '19:00'],
