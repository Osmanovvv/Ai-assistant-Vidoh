 ...
 *
 * Вывезен наружу ревизией панели. Прежде число жило только здесь и
 * проверялось на выставлении счёта, а предел того же поля в реестре
 * настроек стоял свой, в сто раз шире: заказчица вводила 12 000, панель
 * отвечала «Сохранено», и продажа месяца падала уже у человека —
 * `PermanentError` на счёте. Один потолок, одно число.
 */
export const STARS_MAX_SUBSCRIPTION = 10_000;
