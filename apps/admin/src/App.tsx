...
/**
 * Панель (§15 ТЗ, задачи 4.5, 4.6, 4.7, 4.9).
 *
 * Пока здесь вход, обзор, люди, расходы и настройки: промпты и рассылка
 * приезжают задачами 4.8 и 4.10. Показывается ровно то, что уже правда,
 ...
 *
 * §15 просит восемь; промпты и рассылка приезжают задачами 4.8 и
 * 4.10. Пустой
