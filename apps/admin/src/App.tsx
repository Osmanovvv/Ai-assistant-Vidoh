 ...
 *
 * Пока здесь только каркас и вход: восемь разделов §15 приезжают
 * задачами 4.6–4.10. Каркас показывает ровно то, что уже правда, —
 * кто вошёл и как выйти, — и ни строчки обещаний вроде пустых вкладок
 * «Скоро». Пустая вкладка учит, что панели верить нельзя.
 *
