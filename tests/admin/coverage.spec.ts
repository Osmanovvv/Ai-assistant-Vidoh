 ...
 * из §15». Восемь разделов, и три из них ещё не существуют: промпты
 * приезжают задачей 4.8, рассылка и ошибки — задачей 4.10.
 *
 ...
 * сегодня: три её восьмых зависят от чужих задач. Список, живущий в
...
test.describe('покрытие разделов §15', () => {
  ...
  test('непокрытые разделы названы вместе с задачей, которая их принесёт', () => {
     ...
     * приёмке. Когда 4.8 и 4.10 закроются, здесь появятся файлы, и эта
     * проверка напомнит поправить список.
     */
